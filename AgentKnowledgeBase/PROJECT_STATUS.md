...
**Updated by:** P0 datasheet extraction pass
...
| `P0-DOC-02_instrument_datasheet_extract.md` | Draft — PARTIAL (extraction complete, verification and manuals outstanding) |
| `command_register.md` | Draft — **0 approved entries**, 1 of 4 instruments transcribed, 3 blocked |
...
| DAQ3120 programming manual | **MISSING** |
| Tektronix programmer manual `077-1149-xx` | **MISSING** |
| ITECH IT-M3906B user + programming manual (incl. P-IO pinout) | **MISSING** |
...
|---|---|---|---|
| T-01 | DAQ3120 programming manual | **TBD** | **TBD** |
| T-02 | Tektronix programmer manual `077-1149-xx` | **TBD** | **TBD** |
| T-03 | ITECH IT-M3906B manual **incl. P-IO pinout** | **TBD** | **TBD** |
...
| T-08 | DAQ3120 installed module and slot list (finding F-DAQ-01) | **TBD** | **TBD** |
...
**Start Phase 1: the simulation-mode application skeleton, using the scope and ready-to-paste prompt in `NEXT_STEP_BRIEF.md` §2–3.**

In parallel, a human must begin collecting T-01 through T-09. Phase 2 (any real transport, any hardware command) stays blocked until those land and are reviewed.
